...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var btnIniciar = document.getElementById("enviar");
  var btnRegistrar = document.getElementById("login");
  ...
  function validarPassword(password) {
    var minimoOcho = /.{8,}/;
    var contieneMayuscula = /[A-Z]/;
    var contieneNumero = /[0-9]/;
  ...
  btnIniciar.addEventListener("click", function (e) {
    ...
    var email = emailInput.value.trim();
    var password = passwordInput.value;
    var datosGuardados = JSON.parse(localStorage.getItem("usuario"));
  ...
  var savedData = JSON.parse(localStorage.getItem("usuario"));
